...
function Abstract4({ isFlipped, textColor, logo, companyName, name, subtitle, QRCodeCanvas }) {
  return (
    <div
      className="relative w-80 h-48 rounded-lg shadow-lg border p-4 perspective-1000"
